...
plot(steam$price,jitter(log(steam$owners)),xlim=c(0,80))
plot(jitter(steam$release_year),jitter(log(steam$owners)))
plot(log(steam$total_ratings),jitter(log(steam$owners)))
