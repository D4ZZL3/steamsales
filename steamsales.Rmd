...
Introduction
The video game industry has developed significantly since the invention of the home computer. One market in particular which has sprung into mainstream audiences is the market for downloadable computer games. Steam is an online platform where players can purchase and download games, create friends lists, and chat with other players. On Steam, there is a marketplace where developers can publish their work and put a price on their products. As the industry attracts more attention from investors and developers alike, there is a growing interest in what makes certain titles so popular among audiences.

This report will investigate the question of what makes a game popular on Steam. Our definition of popular is a large number of people who own the game. We choose this definition over others because the biggest titles on Steam are typically massive multiplayer games where a large number of owners contribute to the game's status and health. With a large playerbase, developers are more likely to push new content and patch existing problems because there are more people who experience them. 

We will use a multilevel ordinal model with random effects between game genres. The dataset is taken from the Steamspy API by Nik Davis who published it on Kaggle and analyzes it in his own blog. (source) Davis has provided valuable insights to the data through his own EDA, which looks at the effect of price and ownership on computed rating scores. 
